...
<script type="text/javascript" src="${pageContext.request.contextPath}/client/js/formModify.js"></script>
</head>
<body class="main">
	...
	<div id="divpagecontent">
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<form action="${pageContext.request.contextPath}/modifyUser" method="post" onsubmit="return checkForm();">
							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><span id="passwordMsg"></span><font color="#999999">密码至少6位，并区分大小写</font></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="2">&nbsp;&nbsp;
										 ...
										 -->
										<td colspan="2">&nbsp;&nbsp;
											<input type="radio" name="radiobutton" value="男" ${user.gender=='男'?'checked':'' }/>男
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="radiobutton" value="女" ${user.gender=='女'?'checked':'' }/>女
										</td>
									</tr>
									<tr>
								...
								<input name="image" type="image" onclick="return formcheck()"
																		src="${pageContext.request.contextPath }/client/images/botton_gif_025.gif" border="0" width="140" height="35" />
